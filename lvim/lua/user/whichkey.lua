...
-- lvim.builtin.which_key.mappings["F2"] = { "<cmd>ToggleTerm<cr>", "Terminal" }
...
lvim.builtin.which_key.mappings["l"] = {
  ...
  r = { "<cmd>Lspsaga lsp_finder<CR>", "show definition, references" },
  D = { "<Cmd>lua vim.lsp.buf.declaration()<CR>", "got to declaration" },
